...
from src.KidneyProject.entity.config_entity import (DataIngestionConfig, PrepareBaseModelConfig, TrainingConfig, EvaluationConfig)
...
class ConfigurationManager:
    ...
    def get_evaluation_config(self) ->  EvaluationConfig:
            eval_config = EvaluationConfig(
                ...
                mlflow_url="https://dagshub.com/giridharanv16/Capstone-Project.mlflow",
